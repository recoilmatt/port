        ...
        <div className="inner">
          ...
          <section class="overview">
            ...
            <p>
              ...
              form of telemedicine / appointment scheduling. Features were
              outlined that would be prominent in this application that would
              fill the gap in the problems in current applications. In addition,
              a simple financial model was also calculated with a low adoption
              rate.
            </p>
          </section>
        </div>
