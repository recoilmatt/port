    ...
    <section id="banner" className="major">
        <div className="inner">
          ...
          <div className="grid-wrapper">
            <div className="col-6"><p>By integrating my experiences in biological sciences, healthcare, and digital marketing, I am able to apply my skills towards the design process in order to create meaningful digital products that solve problems and improve usability. I'd like to expand my skills to become a UX Engineer in the future.
            </p>
            ...
            {/*
            <div className="col-4">
            <img src={Contact} style={{margin:"auto",borderRadius: "8px", maxWidth: "100%", maxHeight: "20vh"}}alt="" />
            <img src={Contact} style={{margin:"auto",borderRadius: "8px", maxWidth: "100%", maxHeight: "20vh"}}alt="" />
            <img src={Contact} style={{margin:"auto",borderRadius: "8px", maxWidth: "100%", maxHeight: "20vh"}}alt="" />
            ...
            <div className="col-6"> 
            <img src={Contact} style={{display:"block",margin:"auto",borderRadius: "8px", maxWidth: "100%", maxHeight: "50vh"}}alt="" />
            </div>
          </div>
        </div>
    </section>
